...
namespace WebSim.Persistence
{
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public DatabaseInitializer(DatabaseService context, IAccountManager accountManager, ILogger<DatabaseInitializer> logger)
        {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "rahul.n@q1code.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "q1code.com@gmail.com", "+1 (123) 000-0001", new string[] { userRoleName });
